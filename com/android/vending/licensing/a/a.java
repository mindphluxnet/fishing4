...
public class a {
   ...
   public static byte[] a(String var0) {
      ...
      for(var2 = 0; var4 < var6; var4 = var5) {
         byte var1 = (byte)(var9[var4 + 0] & 127);
         var5 = var10[var1];
         if (var5 < -5) {
            throw new b("Bad Base64 input character at " + var4 + ": " + var9[var4 + 0] + "(decimal)");
         }

         if (var5 >= -1) {
            if (var1 == 61) {
               var5 = var6 - var4;
               byte var7 = (byte)(var9[var6 - 1 + 0] & 127);
               if (var3 != 0 && var3 != 1) {
                  if (var3 == 3 && var5 > 2 || var3 == 4 && var5 > 1) {
            ...
            var8[var3] = var1;
            if (var5 == 4) {
               var3 = a(var8, var11, var2, var10) + var2;
               var2 = 0;
            } else {
               var3 = var2;
               var2 = var5;
      ...
      if (var3 != 0) {
         ...
         var8[var3] = 61;
         var4 = var2 + a(var8, var11, var2, var10);
      }
